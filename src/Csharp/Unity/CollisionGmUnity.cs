...
/// <summary>
/// Provides static methods for basic 2D intersection and collision detection for Unity.
/// </summary>
public static class CollisionGmUnity
{
    /// <summary>
    ...
    public static bool CheckCircleVsCircle(float2 center1, float radius1, float2 center2, float radius2)
    {
    ...
    /// <returns>True if the circles intersect or touch; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckCircleVsCircle(float2 center1, float radius1, Vector2 center2, float radius2)
    {
        return GeometryGm.GetDistanceSquared(center1.x, center1.y, center2.x, center2.y) <= (radius1 + radius2) * (radius1 + radius2);
    }
    /// <summary>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckAABBVsAABB(float2 box1, float width1, float height1, float2 box2, float width2, float height2)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckCircleVsAABB(float2 circle, float radius, float2 aabb, float width, float height)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckSegmentVsSegment(float2 p0, float2 p1, float2 p2, float2 p3)
    {
